...
// Description: точка входа хоста с окном под X11
...
void usage()
{
    ...
    "                                      FOR, Alt+S — SELECT\n"
    "\nСочетания, которые забрал себе оконный распорядитель, до эмулятора\n"
    "не доходят: их отнимают в его настройках.\n");
}
