...
public:
    ...
    //
    // По умолчанию хост умеет то, что у него вообще есть: вывод на экран и
    // на АЦПУ. Для всего прочего возвращается false — «такого устройства
    // нет», и программа останавливается. Молча терять данные нельзя: обмен
