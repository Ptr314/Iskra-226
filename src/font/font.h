...
//
// **Глиф и знакоместо — разные вещи.** Глиф 5x8 сидит в поле 7x10: два
// столбца просвета справа, снизу межстрочный интервал и строка, в которой
// стоит курсор (подстрочная черта). Растеризатор меряет кадр знакоместами, а не
// глифами — просвет живёт именно в поле.
class Font
{
public:
    // Знакогенератор самой «Искры»: глиф 5x8 в поле 7x10, текстовый блок
    // 560x240 при 80x24. Снят с рис. 3.1 руководства по БОСГИ —
