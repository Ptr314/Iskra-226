...
// в поле 8x10: столбец поля справа, снизу межстрочный интервал и
...
{
public:
    // Достоверный знакогенератор: 7x8 в поле 8x10, кадр 640x240 при 80x24 —
    // а с точкой вдвое выше своей ширины ровно 4:3 (host_common/renderer.h).
