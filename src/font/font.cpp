...
{
    // Глиф 7x8 в поле 9x10: столбец поля слева и справа (в дампе ПЗУ они
    // пусты у всех 256 глифов), снизу межстрочный интервал и строка курсора.
    static const Font f(7, 8, 9, 10, 1, 0, glyphs_7());
    return f;
}
