...
const Form FORMS[] = {
    ...
    { "PLOT <,,R>", "06 00 05 D7 DE DE E7 D4", "PLOT с пустыми элементами" },
    { "PLOT <A,B,U>", "06 00 07 D7 00 DE 01 DE E5 D4", "PLOT с пером U" },
    { "PLOT <A,B,D>", "06 00 07 D7 00 DE 01 DE E6 D4", "PLOT с пером D" },
    { "PLOT <A,B,S>,<C,,C>", "06 00 0E D7 00 DE 01 DE E8 D4 DE D7 02 DE DE E9 D4", "две группы, перо S и C" },
    { "PLOT <A+1,2*B,\"X\">", "06 00 0F D7 00 EA E8 01 DE E8 02 DF 01 DE E3 01 58 D4", "третий элемент — литерал" },
    { "PLOT <,,STR(A" "\xC2\xA4" ",1,4)>", "06 00 0C D7 DE DE E1 00 E8 01 DE E8 04 D0 D4", "третий элемент — вырезка" },
    { "\xC2\xA4" "OPEN A" "\xC2\xA4" "()", "06 0F 02 E0 00", "¤OPEN" },
    { "\xC2\xA4" "OPEN A" "\xC2\xA4" "(),B" "\xC2\xA4" "()", "06 0F 05 E0 00 DE E0 01", "¤OPEN с двумя буферами" },
    { "\xC2\xA4" "OPEN ,B" "\xC2\xA4" "()", "06 0F 03 DE E0 00", "¤OPEN с пропущенным первым" },
    { "NPLOT A" "\xC2\xA4" "(),10,20", "06 19 08 E0 00 DE E8 10 DE E8 20", "NPLOT" },
    { "DRAW A" "\xC2\xA4" "(),10,20", "06 15 08 E0 00 DE E8 10 DE E8 20", "DRAW" },
    { "DDRAW A" "\xC2\xA4" "(),0,-3", "06 14 09 E0 00 DE E8 00 DE E9 E8 03", "DDRAW приращением" },
    { "DOT A" "\xC2\xA4" "(),7,9", "06 13 08 E0 00 DE E8 07 DE E8 09", "DOT" },
    { "LABEL A" "\xC2\xA4" "(),,,\"Y\"", "06 1E 08 E0 00 DE DE DE E3 01 59", "LABEL с пропущенными признаками" },
    { "LABEL A" "\xC2\xA4" "()3,,,\"Q\"", "06 1E 0A E0 00 E8 03 DE DE DE E3 01 51", "LABEL с множителем размера" },
    { "WINDOW 0,559,0,255", "06 23 0D E8 00 DE E7 05 59 DE E8 00 DE E7 02 55", "WINDOW" },
    { "FRAME A" "\xC2\xA4" "(),0,10,0,10", "06 1D 0E E0 00 DE E8 00 DE E8 10 DE E8 00 DE E8 10", "FRAME" },
    { "\xC2\xA4" "MOVE A" "\xC2\xA4" "(),I,J", "06 1A 06 E0 00 DE 01 DE 02", "¤MOVE" },
    { "TURN A" "\xC2\xA4" "(),R,N,F", "06 1B 08 E0 00 DE 01 DE 02 DE 03", "TURN" },
    { "STRETCH A" "\xC2\xA4" "(),0,0,C,1/S", "06 1C 0F E0 00 DE E8 00 DE E8 00 DE 01 DE E8 01 DC 02", "STRETCH" },
    { "\xC2\xA4" "LET A" "\xC2\xA4" "()=A" "\xC2\xA4" "()", "06 22 05 E0 00 D9 E0 00", "¤LET" },
    { "\xC2\xA4" "LET A" "\xC2\xA4" "()=0", "06 22 05 E0 00 D9 E8 00", "¤LET с обнулением" },
    { "\xC2\xA4" "COPY /10,A" "\xC2\xA4" "()", "06 1F 06 DC DE 10 DE E0 00", "¤COPY на устройство" },
    ...
    { "MAT PRINT A", "06 05 02 E0 00", "MAT PRINT" },
    { "MAT PRINT A;", "06 05 03 E0 00 DD", "MAT PRINT в плотном формате" },
    { "MAT PRINT A,B", "06 05 05 E0 00 DE E0 01", "MAT PRINT списком" },
    { "MAT PRINT /0C,A", "06 05 06 DC DE 0C DE E0 00", "MAT PRINT на другое устройство" },
    ...
    { "LIST S 6000", "33 02 60 00", "LIST S — глагол 33, L2 2541" },
    { "A=SIN(X)", "36 05 00 D9 F9 01 D0", "SIN( — токен F9" },
    { "A=COS(X)", "36 05 00 D9 FA 01 D0", "COS( — токен FA" },
    { "A=TAN(X)", "36 05 00 D9 FB 01 D0", "TAN( — токен FB" },
    { "A=ARCSIN(X)", "36 05 00 D9 FC 01 D0", "ARCSIN( — токен FC" },
    { "A=ARCCOS(X)", "36 05 00 D9 FD 01 D0", "ARCCOS( — токен FD" },
    { "A=ARCTAN(X)", "36 05 00 D9 FE 01 D0", "ARCTAN( — токен FE" },
    { "IF A=1XOR B=2THEN 30", "24 0C 00 D9 E8 01 E5 01 D9 E8 02 D3 00 30", "связка XOR — токен E5" },
    { "SELECT D", "54 01 01", "единицы углов: градусы" },
    { "SELECT R", "54 01 02", "единицы углов: радианы" },
    { "SELECT G", "54 01 03", "единицы углов: грады" },
    { "SELECT D,PRINT 0C", "54 04 01 DE 07 0C", "единицы углов вместе с группой" },
    { "MAT A()=CON", "06 01 04 E0 00 D9 F0", "MAT CON — токен F0" },
    { "MAT A()=IDN", "06 01 04 E0 00 D9 EE", "MAT IDN — токен EE" },
    { "LIST S/05,100,200", "33 09 DC DE 05 DE 01 00 DE 02 00", "LIST S с устройством и диапазоном" },
    ...
    { "SAVE DA F(20)", "73 05 00 EB E8 20 D0", "SAVE DA — глагол 73" },
    { "SAVE DA F(20,A)", "73 07 00 EB E8 20 DE 00 D0", "SAVE DA с приёмником" },
    ...
    { "DATA SAVE DC CLOSE ALL", "77 01 CB", "закрытие всех файлов" },
    { "DATA SAVE DC CLOSE #2", "77 03 DB E8 02", "закрытие строки таблицы" },
